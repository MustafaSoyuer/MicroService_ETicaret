...
import static com.mustafa.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> elasticServiceHandler(ElasticServiceException userServiceException){
